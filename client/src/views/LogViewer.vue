...
import { fetchLogs, clearLogs, clearLogDisplay, apiUrl } from '../api'
...
function startEventSource() {
  stopEventSource()
  eventSource = new EventSource(apiUrl('/logs/stream'))
...
<style scoped>
:deep(.logs-toolbar .el-button--default) { font-weight: 500; color: #000; }
.logs-body {
  display: flex;
...
<style>
/* 日志查看器弹窗：标题底部间距去掉（默认 el-dialog__header padding-bottom 16px） */
.logs-dialog .el-dialog__header { padding-bottom: 0; }
</style>
