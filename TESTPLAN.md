...
| 7 | 日志 | POST logs type=10 op=2 | type=10 op=2（前端浏览） |
...
**激活的日志类型**：type=1 op=0/1/2（新增取消/成功/拒绝）、type=2 op=1（替换成功）、type=4 op=0/1（删除取消/回收站）、type=5 op=1/2（下载成功/失败）、type=6 op=1/2（打开成功/失败）、type=7 op=1/2/3/4/5/6/7（根目录增删/拒绝/取消/重命名）、type=8 op=1/2（配置修改/失败）、type=10 op=2/3（浏览）、type=11 op=0/1/2（日志清空）
