...
**直接预览**：点击**视频**（mp4/webm/mkv/mov 等）或 **Markdown**（.md）文件名，会直接弹出预览——视频在线播放、可拖进度条；Markdown 渲染成排版后的页面（标题、列表、代码、表格）。其他文件点击无反应，下载/打开仍走行末按钮。
...
手机上文件以卡片形式展示，行末的图标按钮分别是进入目录、下载、删除：

<p align="center"><img src="images/mobile-list.png" alt="移动端卡片列表" width="390"></p>
